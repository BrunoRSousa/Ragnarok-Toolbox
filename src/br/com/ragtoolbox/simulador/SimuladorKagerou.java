...
public class SimuladorKagerou extends Activity {
		...
		btContratoDasSombrasInterrogacao,
		btEsmagamentoSombrioInterrogacao,
		btVazioDasSombrasInterrogacao;
		...
		btContratoDasSombrasDiminuir,
		btEsmagamentoSombrioDiminuir,
		btVazioDasSombrasDiminuir;
		...
		btContratoDasSombrasAumentar,
		btEsmagamentoSombrioAumentar,
		btVazioDasSombrasAumentar;
		...
		txtContratoDasSombrasPontos,
		txtEsmagamentoSombrioPontos,
		txtVazioDasSombrasPontos;
		...
		layContratoDasSombras,
		layEsmagamentoSombrio,
		layVazioDasSombras;
		...
		varContratoDasSombras,
		varEsmagamentoSombrio,
		varVazioDasSombras;
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.activity_simulador_kagerou);
			...
			varContratoDasSombras = 0;
			varEsmagamentoSombrio = 0;
			varVazioDasSombras = 0;
			...
			btContratoDasSombrasInterrogacao = (Button) findViewById(R.id.btContratoDasSombrasInterrogacao);
			btEsmagamentoSombrioInterrogacao = (Button) findViewById(R.id.btEsmagamentoSombrioInterrogacao);
			btVazioDasSombrasInterrogacao = (Button) findViewById(R.id.btVazioDasSombrasInterrogacao);
			...
			btContratoDasSombrasDiminuir = (Button) findViewById(R.id.btContratoDasSombrasDiminuir);
			btEsmagamentoSombrioDiminuir = (Button) findViewById(R.id.btEsmagamentoSombrioDiminuir);
			btVazioDasSombrasDiminuir = (Button) findViewById(R.id.btVazioDasSombrasDiminuir);
			...
			btContratoDasSombrasAumentar = (Button) findViewById(R.id.btContratoDasSombrasAumentar);
			btEsmagamentoSombrioAumentar = (Button) findViewById(R.id.btEsmagamentoSombrioAumentar);
			btVazioDasSombrasAumentar = (Button) findViewById(R.id.btVazioDasSombrasAumentar);
			...
			txtContratoDasSombrasPontos = (TextView) findViewById(R.id.txtContratoDasSombrasPontos);
			txtEsmagamentoSombrioPontos = (TextView) findViewById(R.id.txtEsmagamentoSombrioPontos);
			txtVazioDasSombrasPontos = (TextView) findViewById(R.id.txtVazioDasSombrasPontos);
			...
			layContratoDasSombras = (LinearLayout) findViewById(R.id.layContratoDasSombras);
			layEsmagamentoSombrio = (LinearLayout) findViewById(R.id.layEsmagamentoSombrio);
			layVazioDasSombras = (LinearLayout) findViewById(R.id.layVazioDasSombras);
			...
			btAuraNinjaInterrogacao.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					AlertDialog.Builder dialogo = new AlertDialog.Builder(SimuladorKagerou.this);
			...
			btContratoDasSombrasInterrogacao.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					AlertDialog.Builder dialogo = new AlertDialog.Builder(SimuladorKagerou.this);
					dialogo.setTitle("Contrato Das Sombras");
					dialogo.setMessage(R.string.contratoDasSombrasInfo);
					dialogo.setNeutralButton("Fechar info", null);
					dialogo.show();
				}
			});
			btEsmagamentoSombrioInterrogacao.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					AlertDialog.Builder dialogo = new AlertDialog.Builder(SimuladorKagerou.this);
					dialogo.setTitle("Esmagamento Sombrio");
					dialogo.setMessage(R.string.esmagamentoSombrioInfo);
					dialogo.setNeutralButton("Fechar info", null);
					dialogo.show();
				}
			});
			btVazioDasSombrasInterrogacao.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					AlertDialog.Builder dialogo = new AlertDialog.Builder(SimuladorKagerou.this);
					dialogo.setTitle("Vazio Das Sombras");
					dialogo.setMessage(R.string.vazioDasSombrasInfo);
					dialogo.setNeutralButton("Fechar info", null);
					dialogo.show();
				}
			});
			...
			btContratoDasSombrasAumentar.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					count = 0;
					while(varGenjutsuCloneDasSombras<1 && count<1){
						atualizarCalculo(varGenjutsuCloneDasSombras, "GenjutsuCloneDasSombras", 5, 2, "Aumentar");
						count++;
					}
					count = 0;
					while(varEsmagamentoSombrio<2 && count<2){
						atualizarCalculo(varEsmagamentoSombrio, "EsmagamentoSombrio", 5, 2, "Aumentar");
						count++;
					}
					count = 0;
					while(varVazioDasSombras<3 && count<3){
						atualizarCalculo(varVazioDasSombras, "VazioDasSombras", 5, 2, "Aumentar");
						count++;
					}
					count = 0;
					atualizarCalculo(varContratoDasSombras, "ContratoDasSombras", 5, 2, "Aumentar");

				}
			});
			btEsmagamentoSombrioAumentar.setOnClickListener(new View.OnClickListener() {
			...
			btVazioDasSombrasAumentar.setOnClickListener(new View.OnClickListener() {
			...
			btContratoDasSombrasDiminuir.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View v) {
					atualizarCalculo(varContratoDasSombras, "ContratoDasSombras", 5, 2, "Diminuir");

				}
			});
			btEsmagamentoSombrioDiminuir.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View v) {
					atualizarCalculo(varEsmagamentoSombrio, "EsmagamentoSombrio", 5, 2, "Diminuir");

				}
			});
			btVazioDasSombrasDiminuir.setOnClickListener(new View.OnClickListener() {

				@Override
				public void onClick(View v) {
					atualizarCalculo(varVazioDasSombras, "VazioDasSombras", 5, 2, "Diminuir");
			...
			btSalvar.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					if (id > 0){
						AlertDialog.Builder msgA = new AlertDialog.Builder(SimuladorKagerou.this);
						...
						msgA.setPositiveButton("Salvar como...", new DialogInterface.OnClickListener() {
							...
							@Override
								public void onClick(DialogInterface dialog, int which) {
								AlertDialog.Builder msg = new AlertDialog.Builder(SimuladorKagerou.this);
								msg.setTitle("Escolha um nome");
								msg.setMessage("Escolha um nome para salvar esta simulação:");
								final EditText nomeParaSalvar = new EditText(SimuladorKagerou.this);
					...
					msg.setPositiveButton("Salvar", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							if (nomeParaSalvar.getText().toString().length() <= 0) {
								...
								sf.takeAScreenShot(SimuladorKagerou.this, layPrincipal, nomeParaSalvar.getText().toString());
							}
							}
						});
		...
		public void somenteHabilidadeAprendida(){
			...
			if(varContratoDasSombras==0)
				layContratoDasSombras.setVisibility(View.GONE);
			if(varEsmagamentoSombrio==0)
				layEsmagamentoSombrio.setVisibility(View.GONE);
			if(varVazioDasSombras==0)
				layVazioDasSombras.setVisibility(View.GONE);
		...
		public void atualizarCalculo(int habilidade, String nomeDaHabilidade, int pontosMax, int classe, String acao){
			if (acao=="Aumentar"){
				...
				if (nomeDaHabilidade=="VazioDasSombras" && varContratoDasSombras>=1 && varVazioDasSombras<=03){
					podeDiminuir = false;
				}

				if (nomeDaHabilidade=="GenjutsuCloneDasSombras" && varEsmagamentoSombrio>=1 && varGenjutsuCloneDasSombras<=01){
					podeDiminuir = false;
				}

				if (nomeDaHabilidade=="EsmagamentoSombrio" && varVazioDasSombras>=1 && varEsmagamentoSombrio<=02){
					podeDiminuir = false;
				}
			...
			} else if(nomeDaHabilidade=="ContratoDasSombras"){
				varContratoDasSombras = habilidade;
			} else if(nomeDaHabilidade=="EsmagamentoSombrio"){
				varEsmagamentoSombrio = habilidade;
			} else if(nomeDaHabilidade=="VazioDasSombras"){
				varVazioDasSombras = habilidade;
			}
		...
		public void atualizarTela(){
			...
			txtContratoDasSombrasPontos.setText(varContratoDasSombras + "/5");
			txtEsmagamentoSombrioPontos.setText(varEsmagamentoSombrio + "/5");
			txtVazioDasSombrasPontos.setText(varVazioDasSombras + "/5");
		...
		public void tudoVisivel(){
			...
			layContratoDasSombras.setVisibility(View.VISIBLE);
			layEsmagamentoSombrio.setVisibility(View.VISIBLE);
			layVazioDasSombras.setVisibility(View.VISIBLE);
		...
		public void recarregarBuild(int id){
			...
			Cursor cs = db.rawQuery("SELECT * FROM kagerou WHERE _id = ?", new String[]{String.valueOf(id)});
			...
			varContratoDasSombras = cs.getInt(49);
			varEsmagamentoSombrio = cs.getInt(50);
			varVazioDasSombras = cs.getInt(51);
			...
			public void salvarNoDB(boolean novo, String nomeDaSim){
				try {
					...
					sqlClasse.append("CREATE TABLE IF NOT EXISTS kagerou (");
					...
					sqlClasse.append("skill_contratodassombras INT(2), ");
					sqlClasse.append("skill_esmagamentosombrio INT(2), ");
					sqlClasse.append("skill_vaziodassombras INT(2), ");
					...
					ins.put("skill_contratodassombras", varContratoDasSombras);
					ins.put("skill_esmagamentosombrio", varEsmagamentoSombrio);
					ins.put("skill_vaziodassombras", varVazioDasSombras);
					ins.put("skill_primeira", skillPrimeira);
					ins.put("skill_segunda", skillSegunda);
					if(!novo){
						try {
							db.update("kagerou", ins, idParaAlterar, null);
					...
					if (db.insert("kagerou", "_id", ins) > 0) {
						Toast.makeText(getBaseContext(), "Salvando...",
								Toast.LENGTH_SHORT).show();
						Cursor cs = db.rawQuery("SELECT * from kagerou", null);
						cs.moveToLast();
