...
public class SimuladorBioquimico extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			btPrepararPocaoAumentar.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					count = 0;
					atualizarCalculo(varPrepararPocao, "PrepararPocao", 1, 2, "Aumentar");
			...
			btPrepararPocaoDiminuir.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					atualizarCalculo(varPrepararPocao, "PrepararPocao", 1, 2, "Diminuir");
		...
		public void atualizarTela(){
			...
			txtPrepararPocaoPontos.setText(varPrepararPocao + "/1");
		...
		public boolean onCreateOptionsMenu(Menu menu) {
			...
			getMenuInflater().inflate(R.menu.simulador_bioquimico, menu);
			return true;
		}
