...
public class SimuladorSentinela extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			btDesativarArmadilhaAumentar.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					count = 0;
					atualizarCalculo(varDesativarArmadilha, "DesativarArmadilha", 1, 2, "Aumentar");
			...
			btDesativarArmadilhaDiminuir.setOnClickListener(new View.OnClickListener() {
				...
				@Override
				public void onClick(View v) {
					atualizarCalculo(varDesativarArmadilha, "DesativarArmadilha", 1, 2, "Diminuir");
		...
		public void atualizarTela(){
			...
			txtDesativarArmadilhaPontos.setText(varDesativarArmadilha + "/1");
		...
		public boolean onCreateOptionsMenu(Menu menu) {
			...
			getMenuInflater().inflate(R.menu.simulador_sentinela, menu);
			return true;
		}
